...
const LoginPage = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center">
      <div className="sm:mx-auto sm:w-full sn:max-w-md">
        {/* ロゴ */}
        ...
        <div className="mt-8 bg-white py-8 px-4 shadow-sm rounded-lg sm:px-10">
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-center px-4 py-3 border border-y-gray-300 rounded-lg shadow-sm hover:bg-gray-50">
              ...
              <button className="w-full flex items-center justify-center px-4 py-3 bg-[#00B900] text-white rounded-lg shadow-sm hover:bg-[#00a000]">
                {/* LINEロゴ */}
